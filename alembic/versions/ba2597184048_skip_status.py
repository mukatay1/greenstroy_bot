...
Revision ID: ba2597184048
Revises: 
Create Date: 2024-08-24 06:21:35.064443
...
def downgrade() -> None:
    ...
    sa.Column('skip_time', postgresql.TIME(), autoincrement=False, nullable=True),
